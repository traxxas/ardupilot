...
/** @brief  */
#ifndef HAVE_ENUM_MAV_PX4IO_PARAM_ACTION
#define HAVE_ENUM_MAV_PX4IO_PARAM_ACTION
typedef enum MAV_PX4IO_PARAM_ACTION
{
	MAV_PX4IO_PARAM_ACTION_SET=0, /* Request to set the parameter value | */
	MAV_PX4IO_PARAM_ACTION_READ=1, /* Request to read the parameter value | */
	MAV_PX4IO_PARAM_ACTION_VALUE=2, /* Parameter value response | */
	MAV_PX4IO_PARAM_ACTION_ENUM_END=3, /*  | */
} MAV_PX4IO_PARAM_ACTION;
#endif
...
{
	PX4IO_PARAM_FLIGHTMODE=18, /* Flight mode | */
	PX4IO_PARAM_PITCH_FILM=19, /* Expo Pitch Tilt Angle Setting in FILM | */
	PX4IO_PARAM_PITCH_SPORT=20, /* Expo Pitch Tilt Angle Setting in SPORT | */
	PX4IO_PARAM_PITCH_EXPERT=21, /* Expo Pitch Rate Setting in EXPERT | */
	PX4IO_PARAM_YAW_FILM=22, /* Expo yaw Rate Angle Setting in FILM | */
	PX4IO_PARAM_YAW_SPORT=23, /* Expo yaw Rate Angle Setting in SPORT | */
	PX4IO_PARAM_YAW_EXPERT=24, /* Expo yaw Rate Setting in EXPERT | */
	PX4IO_PARAM_LEFT_AUX=25, /* Transmitter Left AUX Setting | */
	...
	PX4IO_PARAM_ESC_SW_VERSION=43, /* ESC software version | */
	PX4IO_PARAM_RESET_TO_DEFAULT=100, /* Reset all writable parms to factory defaults | */
	PX4IO_PARAMS_ENUM_END=101, /*  | */
} PX4IO_PARAMS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_PX4IO_STATUS
#define HAVE_ENUM_PX4IO_STATUS
typedef enum PX4IO_STATUS
{
	PX4IO_STATUS_OK=0, /* Status ok | */
	PX4IO_STATUS_CMD_ERR=1, /* Unknown command or unknown action error | */
	PX4IO_STATUS_PREFLIGHT_ERR=2, /* Preflight error - vehicle is armed | */
	PX4IO_STATUS_OTHER_ERR=255, /* Other error | */
	PX4IO_STATUS_ENUM_END=256, /*  | */
} PX4IO_STATUS;
#endif
...
#include "./mavlink_msg_px4io_param.h"
